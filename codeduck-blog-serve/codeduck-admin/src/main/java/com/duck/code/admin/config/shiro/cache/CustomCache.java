...
public class CustomCache<K, V> implements Cache<K, V> {
    ...
    // TODO @Value注入失败 @Value("${config.jwt.shiro-cache-expireTime}")
    ...
    private String getKey(Object key) {
        return RedisConstant.PREFIX_SHIRO_CACHE + JwtHelper.getClaim(key.toString()).getClaim("username").asString();
    }
